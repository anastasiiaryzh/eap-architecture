...
├── diagrams/
│   ├── 01-system-context.md         # C4 Level 1 — users and external systems
│   ├── 02-containers.md             # C4 Level 2 — containers, ports, and communication
│   ├── 03-request-lifecycle.md      # Request state machine
│   └── 04-approval-workflow.md      # Approval workflow sequence diagram
└── requirements/
...
|---|---|
| [01 — System Context](diagrams/01-system-context.md) | Users, the EAP system, and external dependencies (C4 Level 1) |
| [02 — Containers](diagrams/02-containers.md) | Docker containers, ports, and inter-service communication (C4 Level 2) |
| [03 — Request Lifecycle](diagrams/03-request-lifecycle.md) | All request states and allowed transitions |
| [04 — Approval Workflow](diagrams/04-approval-workflow.md) | End-to-end sequence: submission → approval → fulfilment |
